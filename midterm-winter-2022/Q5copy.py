...
class LinkedList:
    ...
    def change_last(self, v: int) -> Optional[int]:
        ...
        []
        """
        if False:  # TODO: Replace False with appropriate if-condition
            pass  # TODO: Replace pass with one line of code
        else:
            curr = self._first
            while False:
            ...
            pass  # TODO: Replace pass with one line of code
            curr.item = v
            return answer  # TODO: Replace pass with one line of code

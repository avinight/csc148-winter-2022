...
class User:
    ...
    def retweet(self, new_user: str, tweet: Tweet, new_date: date) -> Tweet:
        ...
        """
        tweet = Tweet(new_user, new_date, tweet.content)
        self.tweets.append(tweet)
        return tweet
    # How easy is it for you to call one over the other
    # If access to current user, its easy enough to have as part of user class
    # If scrolling through lots of tweet objects

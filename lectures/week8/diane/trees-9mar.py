...
=== Module Description ===
Tree code as of Wednesday, March 9th.  Today we did all the planning for the
leaves method. A great exercise would be to finish it before Friday's class.
We left two decisions to be made:
- should we glue the next result in using extend or append?
- do we need all 3 cases that we thought through? In particular, could code for
  the third case handle the second case as well? (See the drawings from my
  ipad.)
